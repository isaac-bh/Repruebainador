# EL REPRUEBAINADOR
*Este software fue creado con el fin de mejorar los procesos en la Universidad de Guadalajara, por lo que es publicado bajo una licencia Affero General Public License GNU AGPLv3 , cualquier modificación de este programa, debera de ser publicado el código fuente bajo la misma licencia.*
